...
read_adjacency_dict('euler_100_121_try1.csv'), 1)
    [[1, 72, 43, 51, 9, 22, 23, 26, 47, 2, 4, 6, 47, 35, 54, 67, 34, 8, 68,\
 62, 55, 99, 68, 67, 40, 7, 70, 18, 89, 91, 3, 49, 45, 39, 15, 27, 30, 36, 10,\
 34, 12, 71, 75, 83, 33, 14, 88, 65, 44, 13, 90, 94, 93, 76, 98, 32, 11, 17, 80,\
 31, 33, 24, 19, 85, 100, 16, 69, 60, 50, 28, 21, 92, 66, 70, 38, 81, 53, 73, 37,\
 41, 74, 81, 88, 96, 95, 42, 78, 99, 92, 77, 84, 64, 87, 5, 97, 98, 59, 91, 58, 95,\
 48, 46, 29, 87, 86, 98, 99, 100, 20, 82, 1], [83, 52, 56, 57, 25, 61, 83],\
 [73, 63, 69, 82, 79, 73]]
    """
    cycles = []
...
'euler_100_121_try1.csv')
 ...
 'euler_100_69_try2.csv')
    ...
    cycles = find_euler_cycles(read_adjacency_dict(
        file_path), graph_copy, start_verticle)
